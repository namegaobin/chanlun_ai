...
**最后更新**: 2026-04-13 00:05 GMT+8

## 缠论算法优化

### 2026-04-13 笔生成算法优化

**参考来源**: `/Users/alvingao/CodeBuddy/joinquant/chanClass.py`

**改进内容**:

1. **笔延伸机制**
   - 同类型分型（顶/顶或底/底）时，检查是否更极端
   - 顶分型：更高时延伸
   - 底分型：更低时延伸
...
**核心代码位置**: `chanlun_local/engine.py` `_calculate_bi()` 方法
